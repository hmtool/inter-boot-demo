...
!function ($) {
    ...
    BootstrapTable.prototype.initBody = function () {
        ...
        $.each(this.options.columns[0], function (i, column) {
            ...
            that.$body.off('click', 'span[data-name="' + column.field + '"]').on('click', 'span[data-name="' + column.field + '"]',
                function (event) {
                    var $this = $(this),
                    ...
                    if ($tr.data("expand")) {
                        ...
                        $this.removeClass(that.options.icons.iconExpand).addClass(that.options.icons.iconCollapse);
                        ...
                        $this.removeClass(that.options.icons.iconCollapse).addClass(that.options.icons.iconExpand);
